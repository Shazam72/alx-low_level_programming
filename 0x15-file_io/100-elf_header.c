...
/**
 * _verify - check if elf file
 * @e_ident: ptr to array
 */
void _verify(unsigned char *e_ident)
{
	int i = 0;
...
/**
 * _entry - print entry point
 * @e_entry: entry point ddress
 * @e_ident: ptr to array
 */
...
/**
 * handle_elf - handle print elf info logic
 * @header: elf header
 */
void handle_elf(Elf64_Ehdr *header)
{
	_verify(header->e_ident);
	printf("ELF Header:\n");
